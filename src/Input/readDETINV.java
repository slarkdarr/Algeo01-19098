...
public class readDETINV {
    ...
    private static double[][] inputkey() {
        ...
        int bariskolom;
        System.out.println("Masukkan N, akan dibuat matriks NxN:");
        bariskolom = input.nextInt();
        System.out.println("Masukkan elemen-elemen matriks");
        double[][] matrix = new double[bariskolom][bariskolom];
    ...
    private static double[][] inputfile() throws FileNotFoundException {
        File file = new File("../test/INPUT DETINV.txt");
